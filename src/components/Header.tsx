  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 w-full p-4 lg:p-3 flex justify-between items-start z-[100]">
        <div className="nav-logo relative z-[100] flex items-center gap-2 lg:gap-3 origin-top-left">
          ...
          <div className="flex flex-col -space-y-1 lg:-space-y-2 mt-1">
            <span className="font-barlow font-normal text-2xl lg:text-3xl min-[2000px]:text-5xl tracking-tight text-base-300">
      ...
      <div className={`floating-nav-buttons fixed z-[1] top-[16px] right-[96px] min-[2000px]:right-[140px] flex items-center gap-2 min-[2000px]:gap-4 invisible opacity-0 pointer-events-none lg:-translate-y-5 ${isMenuOpen ? 'opacity-0 pointer-events-none' : ''}`}>
        ...
        <a href="#" onClick={(e) => e.preventDefault()} className="floating-btn get-sauce relative overflow-hidden group pointer-events-auto bg-base-500 border-2 border-base-500 text-base-100 rounded-[16px] px-4 md:px-6 min-[2000px]:px-10 h-[48px] min-[2000px]:h-[72px] flex items-center justify-center font-barlow font-normal text-lg md:text-xl min-[2000px]:text-3xl transition-all duration-300 ease-out hover:bg-transparent hover:text-base-500 active:scale-[0.95] active:duration-150">
